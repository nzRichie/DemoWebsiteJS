...
// Hide the previous page button on initial load
...
// Changes the progress bar colours to reflect the current page
...
// male buttons clicked, change the gender variable and set the colours of the two buttons
...
// female buttons clicked, change the gender variable and set the colours of the two buttons
...
// Change the age displayed in the span based on input from the slider
...
// Display final score in the span element dedicated to that.
